		...
		<div class="col-sm-12 col-sm-offset-0">
			...
			<div class="panel panel-default">
				...
				<div class="panel-heading" style="position:relative">
					<a href="{{ url() }}/email_templates/form_submitted" class="btn btn-success" role="button">SUBMIT FORM NOTIFICATION</a>
					<a href="{{ url() }}/email_templates/product_installed" class="btn btn-primary" role="button">PRODUCT INSTALLED CONFIRMATION</a>
				</div>
...
@if ($auth_user == 'admin')
						<div class="col-sm-6 success" style="font-family:monospace;">
							<p class="{{ $flash_message[0] }} container-fluid">SUBMIT FORM NOTIFICATION TEMPLATE {{ $flash_message[1] }}</p>
							<form class="form-horizontal" role="form" method="POST" action="{{ url('/email_templates/update_submit_form_confirmation') }}">
								...
								<div style="border: 1px solid #e5e5e5; padding: 10px; margin-bottom:10px">
									...
									<span onclick="copyToClipboard('[%table_with_customer_details%]')"><nobr>[%table_with_customer_details%],</nobr> </span>
...
@endif
						...
						<div class="col-sm-6">
							...
							<pre> <b>Example 1 with only one product (with paypal):</b> </pre>
							<div style="border: 1px solid #cccccc; border-radius: 4px; padding:5px" class="bg-warning">
								{!! $example_template1 !!}
							</div>

							<pre style="margin-top:20px"> <b>Example 2 with few products (without paypal):</b> </pre>
							<div style="border: 1px solid #cccccc; border-radius: 4px; padding:5px" class="bg-warning">
								{!! $example_template2 !!}
							</div>
